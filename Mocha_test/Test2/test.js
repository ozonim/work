...
//End first describe "возводит x в степень n",
  ...
  it("при возведении в отрицательную степень результат NaN", function() {
    assert.isNaN((pow(2, -1)), "Ошибка функции на отрицательное значение");
  });

  it("при возведении в дробную степень результат NaN", function() {
     assert.isNaN(pow(2, 1.5), "Ошибка функции дробное выражение");
   });
...
// Begin describe("любое число, кроме нуля, в степени 0 равно 1"
 ...
 //End Begin describe("любое число, кроме нуля, в степени 0 равно 1"
   ...
   it("ноль в нулевой степени даёт NaN", function() {
     assert.isNaN(pow(0, 0), "Ошибка 0 в степени 0 == NaN");
   });
